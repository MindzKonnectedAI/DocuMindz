...
def main():
    ...
    def convert_to_generation(ai_response: str) -> Sequence[Generation]:
        ...
        generation = Generation(
            text=ai_response,  # The AI response text
            generation_info=None,  # Optional, you can provide extra information if necessary
        )
        
        # Return as a Sequence of Generation
        return [generation]  # Wrap it in a list to match the expected return type
