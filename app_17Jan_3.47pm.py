            ...
            When responding to questions, adhere to the following guidelines:
                ...
                ### *Mode Transitions condition Table Details:* 
                    ...
                    - To determine the transition condition between two modes, you must:
                        ...
                        2. Must always locate the Row in which "to" mode is present.
                        3. The intersection cell of "from" to "to" must always indicate the transition condition.
                        4. Must always double check that the intersection cell lies in the same colum as "from".
                        5. If the cell value is NA , the transition is not possible. Otherwise, note the condition(s) specified in the cell.
